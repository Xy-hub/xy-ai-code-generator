...
import com.xy.aicodegenerator.ai.model.message.*;
import com.xy.aicodegenerator.ai.tools.BaseTool;
import com.xy.aicodegenerator.ai.tools.ToolManager;
...
public class JsonMessageStreamHandler {
     ...
     * @return 处理后的流
     */
    public Flux<String> handle(Flux<String> originFlux, long appId, User loginUser) {
        // 收集数据用于生成后端记忆格式
